...
import { Download, Send, Linkedin, Dribbble, Instagram, Mail } from 'lucide-react';
import profileImage from '../../assets/4770fda97463ab6bf6756bc775069b68d961c6c1.png';
import resumePDF from '../../assets/Karthickraja_Velmurugan_Resume.pdf';
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 order-2 lg:order-1">
            <div className="space-y-6">
              <div className="inline-block px-5 py-2.5 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full">
                <span className="text-[#c7ff4d] transition-all duration-500" key={currentRole}>
                  {roles[currentRole]}
                </span>
              </div>
              
              <h1 className="text-5xl md:text-6xl lg:text-6xl leading-tight">
                Hello! I'm
                <br />
                <span className="text-[#c7ff4d]">Karthickraja</span><span className="text-[#ffffff]"> Velmurugan</span>
              </h1>
              
              <p className="text-white/70 text-lg leading-relaxed max-w-xl">
                I'm a creative designer with 3+ years of experience crafting designs that feel 
                clear, honest, and easy to use. I believe good design makes people's lives easier.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-4">
              <a
                href="/resume.pdf"
                download
                className="group px-8 py-4 bg-[#c7ff4d] text-black rounded-full hover:bg-[#d4ff70] transition-all duration-300 shadow-lg shadow-[#c7ff4d]/20 hover:shadow-[#c7ff4d]/40 hover:-translate-y-1 flex items-center gap-2"
              >
                Download CV
              ...
              <button
                ...
                className="px-8 py-4 border-2 border-white/20 rounded-full hover:border-[#c7ff4d] hover:text-[#c7ff4d] transition-all duration-300 hover:-translate-y-1 flex items-center gap-2"
              >
                Contact Me
                <Send size={18} />
              </button>
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
            <div className="relative w-full max-w-lg">
              {/* Glow Effect */}
              <div className="absolute -inset-8 bg-gradient-to-br from-[#c7ff4d]/20 via-blue-500/20 to-purple-500/20 rounded-[2rem] blur-3xl animate-pulse"></div>
              
              {/* Image Container */}
              <div className="relative">
                {/* Main image wrapper with border gradient */}
              ...
              {/* Decorative Elements */}
              <div className="absolute -top-8 -right-8 w-32 h-32 bg-[#c7ff4d]/10 rounded-full blur-2xl animate-pulse"></div>
              <div className="absolute -bottom-8 -left-8 w-40 h-40 bg-blue-500/10 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '1s' }}></div>
              
              {/* Corner accents */}
              <div className="absolute -top-3 -left-3 w-16 h-16 border-l-2 border-t-2 border-[#c7ff4d]/50 rounded-tl-2xl"></div>
              <div className="absolute -bottom-3 -right-3 w-16 h-16 border-r-2 border-b-2 border-[#c7ff4d]/50 rounded-br-2xl"></div>
            </div>
          </div>
        </div>
      </div>

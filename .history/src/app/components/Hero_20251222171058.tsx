          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
            <div className="relative w-full max-w-lg">
              ...
              <div className="relative">
                ...
                <div className="scale-75 relative rounded-[2rem] overflow-hidden border-2 border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-1 hover:scale-[1.02] transition-all duration-700 shadow-2xl">

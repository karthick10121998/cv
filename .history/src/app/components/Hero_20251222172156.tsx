    ...
    <section className="h-full flex items-center justify-center relative overflow-hidden pt-25">
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end pt-50 sm:pt-6 lg:pt-0">
            <div className="relative w-full max-w-[320px] sm:max-w-[380px] lg:max-w-none">
              {/* Glow Effect */}
              <div
                className="absolute -inset-4 lg:-inset-8 
      bg-gradient-to-br from-[#c7ff4d]/20 via-blue-500/20 to-purple-500/20 
      rounded-[2rem] blur-3xl animate-pulse"
              ></div>

              {/* Image Container */}
              <div className="relative">
                <div
                  className="rounded-[2rem] overflow-hidden border-2 border-white/10 
        bg-gradient-to-br from-white/10 to-white/5 p-1 
        transition-all duration-700 shadow-2xl"
          ...
          bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f]"
              ...
              w-full
              h-auto
              max-h-[360px] sm:max-h-[420px] lg:max-h-none
              object-contain
            "
                    />
                  </div>

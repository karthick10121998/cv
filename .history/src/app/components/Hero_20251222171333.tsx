...
export function Hero() {
  ...
  return (
    <section className="h-full flex items-center justify-center relative overflow-hidden pt-25">
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 order-2 lg:order-1">
            <div className="space-y-6">
              <div className="inline-block px-5 py-2.5 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full">
                <span
                  className="text-[#c7ff4d] transition-all duration-500"
                  key={currentRole}
                >
                  {roles[currentRole]}
                </span>
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
            <div className="relative w-full max-w-lg scale-75 lg:scale-100">
              {/* Glow Effect */}
              ...
              <div className="relative p-0">
                ...
                <div className=" rounded-[2rem] overflow-hidden border-2 border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-1 hover:scale-[1.02] transition-all duration-700 shadow-2xl">
              ...
              <div
                className="absolute -bottom-8 -left-8 w-40 h-40 bg-blue-500/10 rounded-full blur-2xl animate-pulse"
                style={{ animationDelay: "1s" }}
              ></div>
